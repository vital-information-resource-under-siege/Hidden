...
I was going through the busctl monitor as well, Whenever I was trying to pass the message the D-Bus showed error to confirm the authentication being taken place.
